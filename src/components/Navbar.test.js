...
const listRocketTest = [
  {id: '5e9d0d95eda69955f709d1eb', rocket_name: 'Falcon 1', 
  ...
  {id: '5e9d0d95eda69973a809d1ec', rocket_name: 'Falcon 9', 
  ...
  {id: '5e9d0d95eda69974db09d1ed', rocket_name: 'Falcon Heavy', 
  ...
  {id: '5e9d0d96eda699382d09d1ee', rocket_name: 'Starship', 
...
describe('Simulate user navaigation interaction', () => {
  ...
  test('Test navigation ListRocket is the default page', async () => { 
    ...
    await store.dispatch({type: "spacex/rocket/GET_ROCKETS/fulfilled", payload: listRocketTest})
